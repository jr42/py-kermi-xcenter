...
class TestStorageSystemHotWaterControl:
    ...
    @pytest.mark.asyncio
    async def test_get_hot_water_setpoint_constant(self, kermi_client, mock_tcp_client, mock_modbus_response):
    ...
    @pytest.mark.asyncio
    async def test_set_hot_water_setpoint_constant(self, kermi_client, mock_tcp_client, mock_modbus_response):
        ...
        mock_tcp_client.write_register.assert_called_once_with(
            address=102, value=525, slave=51
        )

    @pytest.mark.asyncio
    async def test_set_hot_water_single_charge_active(self, kermi_client, mock_tcp_client, mock_modbus_response):
        ...
        mock_tcp_client.write_register.assert_called_once_with(
            address=103, value=1, slave=51
        )

    @pytest.mark.asyncio
    async def test_set_hot_water_single_charge_setpoint(self, kermi_client, mock_tcp_client, mock_modbus_response):
        ...
        mock_tcp_client.write_register.assert_called_once_with(
            address=104, value=550, slave=51
        )
...
class TestStorageSystemHeatingCircuit:
    ...
    @pytest.mark.asyncio
    async def test_get_heating_circuit_operating_mode(self, kermi_client, mock_tcp_client, mock_modbus_response):
    ...
    @pytest.mark.asyncio
    async def test_set_heating_circuit_energy_mode(self, kermi_client, mock_tcp_client, mock_modbus_response):
        ...
        mock_tcp_client.write_register.assert_called_once_with(
            address=155, value=1, slave=50  # ECO = 1
        )
...
class TestStorageSystemSeasonControl:
    ...
    @pytest.mark.asyncio
    async def test_get_season_selection_manual(self, kermi_client, mock_tcp_client, mock_modbus_response):
    ...
    @pytest.mark.asyncio
    async def test_set_season_selection_manual(self, kermi_client, mock_tcp_client, mock_modbus_response):
        ...
        mock_tcp_client.write_register.assert_called_once_with(
            address=157, value=1, slave=50
        )

    @pytest.mark.asyncio
    async def test_set_summer_mode_heating_off(self, kermi_client, mock_tcp_client, mock_modbus_response):
        ...
        mock_tcp_client.write_register.assert_called_once_with(
            address=158, value=200, slave=50
        )
...
class TestStorageSystemOperatingHours:
    ...
    @pytest.mark.asyncio
    async def test_get_operating_hours_circuit_pump(self, kermi_client, mock_tcp_client, mock_modbus_response):
